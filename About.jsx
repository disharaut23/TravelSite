        ...
        <div className='about' id='aboutP'>
            ...
            <section className='about-mission'>
                <div className='mission-content'>
                    <h2>Our Mission</h2>
                    <p>  At <strong>Explore World</strong>, we believe that travel opens the door to endless possibilities and lifelong memories. Our mission is to make travel accessible, affordable, and enjoyable for everyone. From planning to booking, we’re here to make your journey seamless.
                    </p>
                </div>
